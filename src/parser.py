"""
This module reads the JSON report generated by Google OSV-Scanner. It loads the JSON data and returns it to the main application 
...
"""
Extracts vulnerability information from the OSV-Scanner JSON report.

Parameters:
    data (dict): Parsed JSON data.

Returns:
    list: A list of vulnerability records containing package, version, OSV ID, CVE and CVSS information.
"""
